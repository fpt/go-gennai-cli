...
func main() {
	fmt.Println("=== StructuredLLM with JSON Schema Example ===")
	...
	// Example 3: Model capability detection
...
func capabilityExample() {
	models := []string{
		...
		"llama3.1:8b",        // Unknown model - assume JSON Schema support
		"codellama:13b",      // Unknown model - assume JSON Schema support
	}
