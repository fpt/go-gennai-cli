...
if [ -z "$CLI" ]; then
    ...
    echo "Usage: CLI=path/to/gennai ./testsuite/runner.sh"
    exit 1
fi
...
echo -e "${BLUE}🧪 Running Gennai Matrix Integration Tests${NC}"
...
# Start logging
log_both "=== Gennai Matrix Integration Test Results ==="
